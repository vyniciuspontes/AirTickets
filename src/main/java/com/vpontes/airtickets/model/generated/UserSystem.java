...
public class UserSystem  implements java.io.Serializable {
    ...
    public UserSystem(int id, String firstName, String lastName, String email, String password, String phone) {
        this.id = id;
    ...
    public UserSystem(int id, String firstName, String lastName, String email, String password, String phone, Set orderBookings) {
       this.id = id;
       this.firstName = firstName;
       this.lastName = lastName;
       this.email = email;
